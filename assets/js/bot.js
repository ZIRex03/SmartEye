...
configChatbot.replicas = {
    bot: {
        0: {
            content: 'Привет! Я Орлиный Глаз - бот поддержки сайта <a href="https://smart-eye.vercel.app/index.html" target="_blank">smart-eye.vercel.app</a>', human: [0, 1, 2]
        },
        ...
        4: { content: 'Это веб-приложение, которое с помошью специального алгоритма определяет различные объекты на фотографии. Хотите узнать побольше?', human: [5, 6] },
        5: { content: 'Наш алгоритм использует метод дефрагментации (деление на части). Если хотите получше ознакомиться с этим, то можете перейти на эту страницу <a href="https://smart-eye.vercel.app/project.html" target="_blank">О проекте</a> или скачать презентацию, сделанную нами, по этой ссылке <a href="./assets/images/Интеллект для принятия решений.pptx" target="_blank">Скачать презентацию</a>, либо по кнопке "Презентация" на сайте.', human: [7] },
        6: { content: 'Будем рады тебя видеть снова, {{name}}!', human: [8] },
        /* ... */
    },
    human: {
        ...
        6: {content: 'Вернуться назад', bot: 0},
        7: { content: 'Спасибо, было очень интересно. Пока!', bot: 6 },
        8: {content: 'В начало', bot: 0},
